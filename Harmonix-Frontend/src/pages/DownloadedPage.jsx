    ...
    <MainLayout>
      <div>
        ...
        <div className="p-6">
          ...
          <div className="mb-4">
            <div className="grid grid-cols-12 text-xs text-black dark:text-zinc-400 border-b border-zinc-800 px-4 py-2">
                ...
                >
                  ...
                  <div className="col-span-5 flex items-center gap-3">
                    ...
                    <div>
                      ...
                      {/* <p className="text-sm text-zinc-400">{song.track}</p> */}
                    </div>
                  </div>
