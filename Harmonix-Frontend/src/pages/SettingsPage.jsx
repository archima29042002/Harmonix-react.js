      ...
      <div className="max-w-4xl mx-auto p-6">
        ...
        <div className="space-y-8">
          <section>
            ...
            <div className="space-y-4 rounded-lg p-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Button variant="ghost" className="text-sm bg-purple-700 text-white hover:bg-purple-400 hover:text-black">
                  Manage
                </Button>
              </div> */}
            </div>
          ...
          <section>
            ...
            <div className="space-y-4 rounded-lg p-4">
              ...
              {/* <div className="flex items-center justify-between">
                ...
                <Switch checked={autoplay} className="data-[state=checked]:bg-purple-600" onCheckedChange={setAutoplay} />
              </div> */}
              ...
              <div className="flex items-center justify-between">
                ...
                {/* </div> */}
                {/* <Switch checked={offlineMode} className="data-[state=checked]:bg-purple-600" onCheckedChange={setOfflineMode} /> */}
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4 rounded-lg p-4">
              <div className="flex items-center justify-between">
                ...
                {/* </div> */}
                {/* <Switch checked={explicitContent} className="data-[state=checked]:bg-purple-600" onCheckedChange={setExplicitContent} /> */}
              </div>
          ...
          <button variant="outline"
            className="text-sm bg-purple-700 text-white hover:bg-purple-400 hover:text-black"
            onClick={() => navigate('/')}
          >
           Log Out
          </button> */}
          ...
          <div className="pt-4 pb-8">
            <Button variant="outline" className="text-sm bg-purple-700 text-white hover:bg-purple-400 hover:text-black" onClick={() => navigate('/')}>
              Log Out
            </Button>
          </div>
        </div>
